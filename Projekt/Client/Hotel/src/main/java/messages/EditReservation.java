...
public class EditReservation implements Serializable {
    ...
    public EditReservation(String imie, String nazwisko, String nr_pokoju, LocalDate dataPrzyjazdu, LocalDate dataOdjazdu, String toPay) {
        this.imie = imie;
    ...
    public EditReservation(String idOfReservation,String imie, String nazwisko, String nr_pokoju, LocalDate dataPrzyjazdu, LocalDate dataOdjazdu, String toPay) {
